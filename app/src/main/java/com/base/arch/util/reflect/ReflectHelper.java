package com.base.arch.util.reflect;

import androidx.annotation.NonNull;

import com.base.arch.util.LoggerKt;
...
public final class ReflectHelper {
    ...
    public Object getField(@NonNull String fieldName) {
        ...
        if (field != null) {
            try {
                ...
                LoggerKt.e(TAG, "getField error=%s", e);
            }
        }
        return null;
    }
    ...
    public boolean setField(String fieldName, Object value) {
        ...
        if (field != null) {
            try {
                ...
                LoggerKt.e(TAG, "setField error=%s", e);
            }
        }
        return false;
    }
    ...
    public boolean invoke(Object[] outResult, String methodName, ReflectArgument... args) {
        ...
        if (method != null) {
            try {
                ...
                LoggerKt.e(TAG, "invoke error=%s", e);
            }
        }
        return false;
    }
    ...
    public Object newInstance(ReflectArgument... args) {
        ...
        if (constructor != null) {
            try {
                ...
                LoggerKt.e(TAG, "newInstance error=%s", e);
            }
        }
        return null;
    }
    ...
    private static Field getClassField(Class<?> target, String fieldName) {
        ...
        if (value == NOT_FOUND) {
            LoggerKt.d(TAG, "getClassField NOT_FOUND %s", key);
            return null;
        }
    ...
    private static Constructor getClassConstructor(Class<?> target, Class[] paramTypes) {
        ...
        Object value = CACHE.get(key);
        if (value == NOT_FOUND) {
            LoggerKt.d(TAG, "getClassConstructor NOT_FOUND %s", key);
            return null;
        }
        ...
        if (constructor == null) {
            try {
                ...
                LoggerKt.e(TAG, "getClassConstructor NOT_FOUND %s error=%s", key, e);
            }
    ...
    private static Method getClassMethod(Class<?> target, String methodName, Class[] paramTypes) {
        ...
        Object value = CACHE.get(key);
        if (value == NOT_FOUND) {
            LoggerKt.d(TAG, "getClassMethod NOT_FOUND %s", key);
            return null;
        }
    ...
    static Class getClassForName(String className) {
        ...
        if (value == NOT_FOUND) {
            LoggerKt.d(TAG, "getClassForName NOT_FOUND %s", className);
            return null;
        }
        ...
        if (clazz == null) {
            try {
                ...
                LoggerKt.e(TAG, "getClassForName NOT_FOUND %s error=%s", className, e);
            }
    ...
    private static void putCache(String key, Object value) {
        if (value == null || value == NOT_FOUND) {
            LoggerKt.e(TAG, "NOT_FOUND %s", key);
            value = NOT_FOUND;
        }
        CACHE.put(key, value);
    }
